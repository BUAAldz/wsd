...
class WSD_path(object):
    def __init__(self):
        self.DATA_DIR = '../../wsd_glove_data/data/'
        ...
        # no use
        self.LS_BASE_PATH =_LS_BASE_PATH= self.DATA_DIR+'Lexical_Sample_WSD/'
        ...
        # ALL-words task path
        self.ALL_WORDS_BASE_PATH = _ALL_WORDS_BASE_PATH = self.DATA_DIR + 'All_Words_WSD/'
        ...
        self.WORDNET_PATH = self.DATA_DIR + 'WordNet-3.0'  # todo: change to your wordnet database (version 3.0) path
        self.GLOVE_VECTOR = self.DATA_DIR + 'glove.42B.300d.txt'  # todo: change to your word2vec path
