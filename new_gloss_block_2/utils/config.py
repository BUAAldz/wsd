...
class MemNNConfig(object):
    ...
    def __init__(self):
        ...
        self.gloss_expand_type = 0  # 0=None 1=hyper，2=hypo 3=hyper+hypo 4：hierarchical
        ...
        self.n_epochs = 50
        self.batch_size = 512
        self.lr_start = 0.0005 # 0.001->0.0005
        self.lambda_l2_reg = 0.0001  # L2 regularization 0.0001=>0.0005
        self.momentum = 0.1
        self.max_grad_norm = 10  # clip gradient
        self.dropout = 0.5 # drop out 參數
